...
const FALLBACK_PORTFOLIO = {
  ...
  experience: [
    { title: "ML/AI Engineer Intern", company: "Allyvia", period: "Aug 2026 – Present", location: "Los Angeles Metropolitan Area · Remote", stack: "Django, Django REST Framework, PostgreSQL, QuickBooks Online, Stripe", bullets: ["Resolved critical bugs in a production QuickBooks Online integration that were corrupting financial data, preventing duplicate accounting entries and incorrect payout calculations for SMB customers.", "Built idempotent retry safeguards and 40+ automated tests to make financial API writes reliable against network failures.", "Improved finance dashboard reporting accuracy by tracing and validating P&L metrics end-to-end from raw data to customer-facing results.", "Delivered fintech features independently across Stripe and QuickBooks integrations, from scoping with founders through code review."] },
  ...
  projects: [
    { name: "Ledgerly – AI Treasury Reconciliation Platform", icon: "💼", stack: ["Next.js", "TypeScript", "PostgreSQL", "Prisma", "Anthropic", "Vitest"], githubLink: "https://github.com/NehalGarg29/Ledgerly", demoLink: "https://ledgerly-kohl-three.vercel.app", bullets: ["Built a full-stack municipal treasury platform that ingests bank and general-ledger files for automated reconciliation.", "Combined exact and fuzzy matching with explainable confidence scoring, anomaly detection, and policy checks.", "Added an Anthropic-powered review agent with tool calls, role-based access, audit logs, and compliance evidence exports."] },
    ...
    { name: "DeepResearchAgent – Memory-Augmented Research Assistant", icon: "🔎", stack: ["Python", "FastAPI", "Groq", "ChromaDB", "SQLite", "Docker"], githubLink: "https://github.com/NehalGarg29/DeepResearchAgent", bullets: ["Built an API-backed research agent that decomposes complex questions into focused sub-queries before synthesis.", "Used ChromaDB semantic retrieval and SQLite session logs to create persistent research memory.", "Added token and retrieval budgets plus self-evaluation scoring to make agent behavior observable and bounded."] },
    { name: "AiroLite – AI Resource Optimization for Logistics", icon: "🚚", stack: ["Next.js", "Express", "PostgreSQL", "Prisma", "Claude API", "TypeScript"], githubLink: "https://github.com/NehalGarg29/AiroLite", bullets: ["Developed driver assignment algorithms aligning availability with vehicle specifications and route needs.", "Built a route optimization engine to reorder multi-stop deliveries for shortest path and duration across local networks.", "Designed a Samsung/LG product return Kanban tracker with Claude-backed disposition recommendations."] },
